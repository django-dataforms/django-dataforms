...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Binding.parent'
        db.delete_column('dataforms_binding', 'parent')

        # Adding field 'Binding.additional_rules'
        db.add_column('dataforms_binding', 'additional_rules', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Binding.parent'
        db.add_column('dataforms_binding', 'parent', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Deleting field 'Binding.additional_rules'
        db.delete_column('dataforms_binding', 'additional_rules')
