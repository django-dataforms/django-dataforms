...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Binding.true_choice_value'
        db.add_column('dataforms_binding', 'true_choice_value', self.gf('dataforms.fields.SeparatedValuesField')(default='', blank=True), keep_default=False)

        # Adding field 'Binding.false_choice_value'
        db.add_column('dataforms_binding', 'false_choice_value', self.gf('dataforms.fields.SeparatedValuesField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Binding.true_choice_value'
        db.delete_column('dataforms_binding', 'true_choice_value')

        # Deleting field 'Binding.false_choice_value'
        db.delete_column('dataforms_binding', 'false_choice_value')
    ...
    models = {
        ...
        'dataforms.binding': {
            ...
            'false_choice_value': ('dataforms.fields.SeparatedValuesField', [], {'blank': 'True'}),
            ...
            'true_choice_value': ('dataforms.fields.SeparatedValuesField', [], {'blank': 'True'}),
