...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'CollectionDataForm', fields ['data_form', 'collection']
        db.delete_unique('dataforms_collectiondataform', ['data_form_id', 'collection_id'])

        # Adding unique constraint on 'CollectionDataForm', fields ['section', 'data_form', 'collection']
        db.create_unique('dataforms_collectiondataform', ['section_id', 'data_form_id', 'collection_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CollectionDataForm', fields ['section', 'data_form', 'collection']
        db.delete_unique('dataforms_collectiondataform', ['section_id', 'data_form_id', 'collection_id'])

        # Adding unique constraint on 'CollectionDataForm', fields ['data_form', 'collection']
        db.create_unique('dataforms_collectiondataform', ['data_form_id', 'collection_id'])
