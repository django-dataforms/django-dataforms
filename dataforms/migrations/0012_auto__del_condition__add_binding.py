...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_unique('dataforms_condition_true_choice', ['condition_id', 'fieldchoice_id'])
        ...
        db.create_unique('dataforms_condition_false_choice', ['condition_id', 'fieldchoice_id'])
