...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Condition.action'
        db.add_column('dataforms_condition', 'action', self.gf('django.db.models.fields.CharField')(default='show', max_length=255), keep_default=False)

        # Adding field 'Condition.function'
        db.add_column('dataforms_condition', 'function', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Condition.action'
        db.delete_column('dataforms_condition', 'action')

        # Deleting field 'Condition.function'
        db.delete_column('dataforms_condition', 'function')
