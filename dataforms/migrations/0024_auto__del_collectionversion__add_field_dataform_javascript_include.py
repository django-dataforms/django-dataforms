...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataForm.javascript_include'
        db.add_column('dataforms_dataform', 'javascript_include', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataForm.javascript_include'
        db.delete_column('dataforms_dataform', 'javascript_include')
    ...
    models = {
        ...
        'dataforms.dataform': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'javascript_include': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
